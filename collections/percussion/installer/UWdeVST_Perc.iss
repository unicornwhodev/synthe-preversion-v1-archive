#define AppName "uwdevst_perc"
#ifndef AppVersion
#define AppVersion "1.0.2"
#endif
#define AppPublisher "unicorn who dev / Charli Billabert"
#define AppExeName "uwdevst_perc.exe"
#define Vst3BundleName "uwdevst_perc.vst3"

[Setup]
AppId={{4C4D10F1-AC28-47C3-BE6C-59C0668BDF17}
AppName={#AppName}
...
OutputDir=output
OutputBaseFilename=uwdevst_perc_{#AppVersion}_Windows_x64_Setup
Compression=lzma2
